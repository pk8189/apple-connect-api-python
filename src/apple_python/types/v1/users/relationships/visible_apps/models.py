...
class UserVisibleAppsLinkagesResponseDataItem(_PydanticBaseModel):
...
class UserVisibleAppsLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[UserVisibleAppsLinkagesResponseDataItem] = _PydanticField(
        alias="data"
    )
