...
class UserAttributes(_PydanticBaseModel):
...
class UserRelationshipsVisibleAppsDataItem(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class UserRelationshipsVisibleAppsLinks(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class UserRelationshipsVisibleApps(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.Optional[typing.List[UserRelationshipsVisibleAppsDataItem]] = (
        _PydanticField(alias="data", default=None)
    )
    links: typing.Optional[UserRelationshipsVisibleAppsLinks] = _PydanticField(
        alias="links", default=None
    )
    meta: typing.Optional[PagingInformation] = _PydanticField(
        alias="meta", default=None
...
class UserRelationships(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    visible_apps: typing.Optional[UserRelationshipsVisibleApps] = _PydanticField(
        alias="visibleApps", default=None
    )
...
class User(_PydanticBaseModel):
    ...
    attributes: typing.Optional[UserAttributes] = _PydanticField(
        alias="attributes", default=None
    )
    id: str = _PydanticField(alias="id")
    links: typing.Optional[ResourceLinks] = _PydanticField(alias="links", default=None)
    relationships: typing.Optional[UserRelationships] = _PydanticField(
        alias="relationships", default=None
    )
    type: typing_extensions.Literal["users"] = _PydanticField(alias="type")


class UserResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: User = _PydanticField(alias="data")
...
class UsersResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[User] = _PydanticField(alias="data")
    included: typing.Optional[typing.List[App]] = _PydanticField(
        alias="included", default=None
    )
