...
class AppPromotedPurchasesLinkagesResponseDataItem(_PydanticBaseModel):
...
class AppPromotedPurchasesLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[AppPromotedPurchasesLinkagesResponseDataItem] = _PydanticField(
        alias="data"
    )
