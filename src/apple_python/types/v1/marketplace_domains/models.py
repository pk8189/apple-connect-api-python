...
class MarketplaceDomainAttributes(_PydanticBaseModel):
...
class MarketplaceDomain(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    attributes: typing.Optional[MarketplaceDomainAttributes] = _PydanticField(
        alias="attributes", default=None
    )
    id: str = _PydanticField(alias="id")
    links: typing.Optional[ResourceLinks] = _PydanticField(alias="links", default=None)
    type: typing_extensions.Literal["marketplaceDomains"] = _PydanticField(alias="type")
...
class MarketplaceDomainResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: MarketplaceDomain = _PydanticField(alias="data")
    links: DocumentLinks = _PydanticField(alias="links")


class MarketplaceDomainsResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[MarketplaceDomain] = _PydanticField(alias="data")
