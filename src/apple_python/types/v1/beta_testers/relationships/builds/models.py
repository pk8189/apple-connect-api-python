...
class BetaTesterBuildsLinkagesResponseDataItem(_PydanticBaseModel):
...
class BetaTesterBuildsLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BetaTesterBuildsLinkagesResponseDataItem] = _PydanticField(
        alias="data"
    )
