...
class BetaTesterAppsLinkagesResponseDataItem(_PydanticBaseModel):
...
class BetaTesterAppsLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BetaTesterAppsLinkagesResponseDataItem] = _PydanticField(
        alias="data"
    )
