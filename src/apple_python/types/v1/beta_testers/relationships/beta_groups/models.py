...
class BetaTesterBetaGroupsLinkagesResponseDataItem(_PydanticBaseModel):
...
class BetaTesterBetaGroupsLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BetaTesterBetaGroupsLinkagesResponseDataItem] = _PydanticField(
        alias="data"
    )
