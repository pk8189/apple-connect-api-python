...
class CiXcodeVersionResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: CiXcodeVersion = _PydanticField(alias="data")
    included: typing.Optional[typing.List[CiMacOsVersion]] = _PydanticField(
        alias="included", default=None
    )
    links: DocumentLinks = _PydanticField(alias="links")


class CiXcodeVersionsResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[CiXcodeVersion] = _PydanticField(alias="data")
    included: typing.Optional[typing.List[CiMacOsVersion]] = _PydanticField(
        alias="included", default=None
    )
