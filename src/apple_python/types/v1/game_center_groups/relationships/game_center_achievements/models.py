...
class GameCenterGroupGameCenterAchievementsLinkagesResponseDataItem(_PydanticBaseModel):
...
class GameCenterGroupGameCenterAchievementsLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[GameCenterGroupGameCenterAchievementsLinkagesResponseDataItem] = (
