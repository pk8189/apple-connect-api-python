...
class BetaLicenseAgreementResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class BetaLicenseAgreementsResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BetaLicenseAgreement] = _PydanticField(alias="data")
    included: typing.Optional[typing.List[App]] = _PydanticField(
        alias="included", default=None
    )
