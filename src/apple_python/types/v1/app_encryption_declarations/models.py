...
class AppEncryptionDeclarationResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    included: typing.Optional[
        typing.List[typing.Union[App, Build, AppEncryptionDeclarationDocument]]
    ] = _PydanticField(alias="included", default=None)
    links: DocumentLinks = _PydanticField(alias="links")


class AppEncryptionDeclarationsResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[AppEncryptionDeclaration] = _PydanticField(alias="data")
    included: typing.Optional[
        typing.List[typing.Union[App, Build, AppEncryptionDeclarationDocument]]
    ] = _PydanticField(alias="included", default=None)
