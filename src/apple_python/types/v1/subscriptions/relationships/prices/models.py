...
class SubscriptionPricesLinkagesResponseDataItem(_PydanticBaseModel):
...
class SubscriptionPricesLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[SubscriptionPricesLinkagesResponseDataItem] = _PydanticField(
        alias="data"
    )
