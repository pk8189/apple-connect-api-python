...
class AlternativeDistributionDomainAttributes(_PydanticBaseModel):
...
class AlternativeDistributionDomain(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    attributes: typing.Optional[AlternativeDistributionDomainAttributes] = (
        _PydanticField(alias="attributes", default=None)
    )
    id: str = _PydanticField(alias="id")
    links: typing.Optional[ResourceLinks] = _PydanticField(alias="links", default=None)
    type: typing_extensions.Literal["alternativeDistributionDomains"] = _PydanticField(
        alias="type"
    )
...
class AlternativeDistributionDomainResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: AlternativeDistributionDomain = _PydanticField(alias="data")
    links: DocumentLinks = _PydanticField(alias="links")


class AlternativeDistributionDomainsResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[AlternativeDistributionDomain] = _PydanticField(alias="data")
