...
class BuildBetaDetailResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: BuildBetaDetail = _PydanticField(alias="data")
...
class BuildBetaDetailsResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BuildBetaDetail] = _PydanticField(alias="data")
    included: typing.Optional[typing.List[Build]] = _PydanticField(
        alias="included", default=None
    )
