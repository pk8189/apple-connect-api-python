...
class GameCenterDetailGameCenterLeaderboardSetsLinkagesResponseDataItem(
    _PydanticBaseModel
):
...
class GameCenterDetailGameCenterLeaderboardSetsLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.List[
        GameCenterDetailGameCenterLeaderboardSetsLinkagesResponseDataItem
