...
class GameCenterDetailGameCenterAchievementsLinkagesResponseDataItem(
    _PydanticBaseModel
):
...
class GameCenterDetailGameCenterAchievementsLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.List[
        GameCenterDetailGameCenterAchievementsLinkagesResponseDataItem
