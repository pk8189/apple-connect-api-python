...
class BetaGroupBetaTestersLinkagesResponseDataItem(_PydanticBaseModel):
...
class BetaGroupBetaTestersLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BetaGroupBetaTestersLinkagesResponseDataItem] = _PydanticField(
        alias="data"
    )
