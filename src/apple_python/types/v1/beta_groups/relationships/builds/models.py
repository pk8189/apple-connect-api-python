...
class BetaGroupBuildsLinkagesResponseDataItem(_PydanticBaseModel):
...
class BetaGroupBuildsLinkagesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BetaGroupBuildsLinkagesResponseDataItem] = _PydanticField(
        alias="data"
    )
