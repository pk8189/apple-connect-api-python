...
class InAppPurchaseSubmissionRelationshipsInAppPurchaseV2Data(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class InAppPurchaseSubmissionRelationshipsInAppPurchaseV2Links(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class InAppPurchaseSubmissionRelationshipsInAppPurchaseV2(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.Optional[InAppPurchaseSubmissionRelationshipsInAppPurchaseV2Data] = (
        _PydanticField(alias="data", default=None)
    )
    links: typing.Optional[InAppPurchaseSubmissionRelationshipsInAppPurchaseV2Links] = (
...
class InAppPurchaseSubmissionRelationships(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class InAppPurchaseSubmission(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    relationships: typing.Optional[InAppPurchaseSubmissionRelationships] = (
        _PydanticField(alias="relationships", default=None)
    )
    type: typing_extensions.Literal["inAppPurchaseSubmissions"] = _PydanticField(
        alias="type"
    )
...
class InAppPurchaseSubmissionResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: InAppPurchaseSubmission = _PydanticField(alias="data")
