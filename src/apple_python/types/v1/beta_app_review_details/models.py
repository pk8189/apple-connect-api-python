...
class BetaAppReviewDetailResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class BetaAppReviewDetailsResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BetaAppReviewDetail] = _PydanticField(alias="data")
    included: typing.Optional[typing.List[App]] = _PydanticField(
        alias="included", default=None
    )
