...
class BetaAppReviewSubmissionResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class BetaAppReviewSubmissionsResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[BetaAppReviewSubmission] = _PydanticField(alias="data")
    included: typing.Optional[typing.List[Build]] = _PydanticField(
        alias="included", default=None
    )
