...
class GameCenterMatchmakingQueueResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: GameCenterMatchmakingQueue = _PydanticField(alias="data")
    included: typing.Optional[typing.List[GameCenterMatchmakingRuleSet]] = (
        _PydanticField(alias="included", default=None)
    )
    links: DocumentLinks = _PydanticField(alias="links")


class GameCenterMatchmakingQueuesResponse(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: typing.List[GameCenterMatchmakingQueue] = _PydanticField(alias="data")
    included: typing.Optional[typing.List[GameCenterMatchmakingRuleSet]] = (
        _PydanticField(alias="included", default=None)
    )
