...
class AppAvailabilityV2Attributes(_PydanticBaseModel):
...
class AppAvailabilityV2RelationshipsTerritoryAvailabilitiesDataItem(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class AppAvailabilityV2RelationshipsTerritoryAvailabilitiesLinks(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class AppAvailabilityV2RelationshipsTerritoryAvailabilities(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[
        typing.List[AppAvailabilityV2RelationshipsTerritoryAvailabilitiesDataItem]
    ] = _PydanticField(alias="data", default=None)
    links: typing.Optional[
        AppAvailabilityV2RelationshipsTerritoryAvailabilitiesLinks
    ] = _PydanticField(alias="links", default=None)
...
class AppAvailabilityV2Relationships(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    territory_availabilities: typing.Optional[
        AppAvailabilityV2RelationshipsTerritoryAvailabilities
    ] = _PydanticField(alias="territoryAvailabilities", default=None)
...
class AppAvailabilityV2(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    attributes: typing.Optional[AppAvailabilityV2Attributes] = _PydanticField(
        alias="attributes", default=None
    )
    id: str = _PydanticField(alias="id")
    links: typing.Optional[ResourceLinks] = _PydanticField(alias="links", default=None)
    relationships: typing.Optional[AppAvailabilityV2Relationships] = _PydanticField(
        alias="relationships", default=None
    )
    type: typing_extensions.Literal["appAvailabilities"] = _PydanticField(alias="type")


class AppAvailabilityV2Response(_PydanticBaseModel):
    model_config = _PydanticConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    data: AppAvailabilityV2 = _PydanticField(alias="data")
    included: typing.Optional[typing.List[TerritoryAvailability]] = _PydanticField(
