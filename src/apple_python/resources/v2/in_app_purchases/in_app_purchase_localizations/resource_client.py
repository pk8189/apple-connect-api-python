...
from apple_python.types.v2.in_app_purchases.in_app_purchase_localizations import models
...
class InAppPurchaseLocalizationsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.InAppPurchaseLocalizationsResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v2/inAppPurchases/{id}/inAppPurchaseLocalizations",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.InAppPurchaseLocalizationsResponse,
