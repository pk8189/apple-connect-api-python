...
from apple_python.types.v1.game_center_groups.game_center_leaderboard_sets import models
...
class GameCenterLeaderboardSetsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.GameCenterLeaderboardSetsResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/gameCenterGroups/{id}/gameCenterLeaderboardSets",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.GameCenterLeaderboardSetsResponse,
