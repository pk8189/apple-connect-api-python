...
from apple_python.types.v1.app_infos.secondary_category import models


class SecondaryCategoryClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/appInfos/{id}/secondaryCategory",
...
class AsyncSecondaryCategoryClient:
