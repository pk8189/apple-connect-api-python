...
from apple_python.types.v1.app_infos.secondary_subcategory_one import models


class SecondarySubcategoryOneClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/appInfos/{id}/secondarySubcategoryOne",
...
class AsyncSecondarySubcategoryOneClient:
