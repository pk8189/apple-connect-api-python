...
from apple_python.types.v1.app_infos.primary_subcategory_two import models


class PrimarySubcategoryTwoClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/appInfos/{id}/primarySubcategoryTwo",
...
class AsyncPrimarySubcategoryTwoClient:
