...
from apple_python.types.v1.app_infos.secondary_subcategory_two import models


class SecondarySubcategoryTwoClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/appInfos/{id}/secondarySubcategoryTwo",
...
class AsyncSecondarySubcategoryTwoClient:
