...
from apple_python.types.v1.subscription_offer_codes.one_time_use_codes import models


class OneTimeUseCodesClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.SubscriptionOfferCodeOneTimeUseCodesResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/subscriptionOfferCodes/{id}/oneTimeUseCodes",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.SubscriptionOfferCodeOneTimeUseCodesResponse,
            request_options=request_options or default_request_options(),
        )
        # end -- send sync request (keep comment for code generation)


class AsyncOneTimeUseCodesClient:
