...
from apple_python.types.v1.app_encryption_declarations.app_encryption_declaration_document import (
    models,
)


class AppEncryptionDeclarationDocumentClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/appEncryptionDeclarations/{id}/appEncryptionDeclarationDocument",
...
class AsyncAppEncryptionDeclarationDocumentClient:
