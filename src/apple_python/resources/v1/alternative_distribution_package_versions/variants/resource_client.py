...
from apple_python.types.v1.alternative_distribution_package_versions.variants import (
    models,
)
...
class VariantsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.AlternativeDistributionPackageVariantsResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/alternativeDistributionPackageVersions/{id}/variants",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.AlternativeDistributionPackageVariantsResponse,
