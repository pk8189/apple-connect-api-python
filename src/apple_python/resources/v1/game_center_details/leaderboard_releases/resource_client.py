...
from apple_python.types.v1.game_center_details.leaderboard_releases import models


class LeaderboardReleasesClient:
    ...
    def list(
        ...
        *,
        ...
        filter_game_center_leaderboard: typing.Optional[typing.List[str]] = None,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/gameCenterDetails/{id}/leaderboardReleases",
...
class AsyncLeaderboardReleasesClient:
