...
import typing
from apple_python.types.v1.game_center_details.metrics.classic_matchmaking_requests import (
    models,
)


class ClassicMatchmakingRequestsClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/gameCenterDetails/{id}/metrics/classicMatchmakingRequests",
...
class AsyncClassicMatchmakingRequestsClient:
