...
from apple_python.types.v1.subscription_price_points.equalizations import models
...
class EqualizationsClient:
    ...
    def list(
        ...
        *,
        ...
        filter_subscription: typing.Optional[typing.List[str]] = None,
    ...
    ) -> models.SubscriptionPricePointsResponse:
        """
        ...
        if filter_subscription is not None:
            _query["filter[subscription]"] = encode_param(filter_subscription, False)
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/subscriptionPricePoints/{id}/equalizations",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.SubscriptionPricePointsResponse,
