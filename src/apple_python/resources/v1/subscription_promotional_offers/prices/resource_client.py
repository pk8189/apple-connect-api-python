...
from apple_python.types.v1.subscription_promotional_offers.prices import models
...
class PricesClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.SubscriptionPromotionalOfferPricesResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/subscriptionPromotionalOffers/{id}/prices",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.SubscriptionPromotionalOfferPricesResponse,
