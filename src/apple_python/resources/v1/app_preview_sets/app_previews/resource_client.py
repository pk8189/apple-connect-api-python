...
from apple_python.types.v1.app_preview_sets.app_previews import models
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/appPreviewSets/{id}/appPreviews",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.AppPreviewsResponse,
