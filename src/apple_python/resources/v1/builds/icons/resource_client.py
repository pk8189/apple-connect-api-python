...
from apple_python.types.v1.builds.icons import models
...
class IconsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.BuildIconsWithoutIncludesResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/builds/{id}/icons",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.BuildIconsWithoutIncludesResponse,
            request_options=request_options or default_request_options(),
        )
        # end -- send sync request (keep comment for code generation)


class AsyncIconsClient:
