...
from apple_python.resources.v1.users.relationships import (
    RelationshipsClient,
    AsyncRelationshipsClient,
)
from apple_python.resources.v1.users.visible_apps import (
    AsyncVisibleAppsClient,
    VisibleAppsClient,
)
import typing
import typing_extensions
from apple_python.types.v1.users import models, params
...
class UsersClient:
    ...
    def patch(
        ...
        *,
        ...
        _json = to_encodable(item=data, dump_with=params._SerializerUserUpdateRequest)
    ...
    def get(
        ...
        *,
        ...
        if fields_users is not None:
            _query["fields[users]"] = encode_param(fields_users, False)
    ...
    def list(
        ...
        *,
        ...
        filter_username: typing.Optional[typing.List[str]] = None,
        ...
        if filter_username is not None:
            _query["filter[username]"] = encode_param(filter_username, False)
