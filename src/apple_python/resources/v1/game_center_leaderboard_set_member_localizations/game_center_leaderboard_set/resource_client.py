...
from apple_python.types.v1.game_center_leaderboard_set_member_localizations.game_center_leaderboard_set import (
    models,
)


class GameCenterLeaderboardSetClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/gameCenterLeaderboardSetMemberLocalizations/{id}/gameCenterLeaderboardSet",
...
class AsyncGameCenterLeaderboardSetClient:
