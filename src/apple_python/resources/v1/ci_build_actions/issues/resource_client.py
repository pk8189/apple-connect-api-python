...
from apple_python.types.v1.ci_build_actions.issues import models
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/ciBuildActions/{id}/issues",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.CiIssuesResponse,
