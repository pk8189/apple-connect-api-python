...
from apple_python.types.v1.apps.promoted_purchases import models
...
class PromotedPurchasesClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.PromotedPurchasesResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/apps/{id}/promotedPurchases",
            auth_names=["itc-bearer-token"],
            query_params=_query,
            cast_to=models.PromotedPurchasesResponse,
