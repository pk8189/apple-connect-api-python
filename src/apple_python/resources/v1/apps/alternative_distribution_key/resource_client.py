...
from apple_python.types.v1.apps.alternative_distribution_key import models


class AlternativeDistributionKeyClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/apps/{id}/alternativeDistributionKey",
...
class AsyncAlternativeDistributionKeyClient:
