...
import typing
from apple_python.types.v1.game_center_matchmaking_queues.metrics.matchmaking_requests import (
    models,
)


class MatchmakingRequestsClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/gameCenterMatchmakingQueues/{id}/metrics/matchmakingRequests",
...
class AsyncMatchmakingRequestsClient:
