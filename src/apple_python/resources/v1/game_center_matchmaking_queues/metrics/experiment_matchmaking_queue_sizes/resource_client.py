...
import typing
from apple_python.types.v1.game_center_matchmaking_queues.metrics.experiment_matchmaking_queue_sizes import (
    models,
)


class ExperimentMatchmakingQueueSizesClient:
    ...
    def list(
        ...
        *,
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/gameCenterMatchmakingQueues/{id}/metrics/experimentMatchmakingQueueSizes",
...
class AsyncExperimentMatchmakingQueueSizesClient:
